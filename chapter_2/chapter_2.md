...
![](chapter_2_files/figure-gfm/unnamed-chunk-2-1.png)<!-- -->
...
![](chapter_2_files/figure-gfm/unnamed-chunk-4-1.png)<!-- -->
...
**2M2.** Now assume a prior for p that is equal to zero when p \< 0.5
